...
public class FirstServlet3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//get방식
//		RequestDispatcher dispatch = request.getRequestDispatcher("secondDispatcher?language=java,html,css,javascript,sql");
//		dispatch.forward(request, response);
		
		//바인딩
		request.setAttribute("language", "java");
		request.setAttribute("name", "안젤리나졸려");
		request.setAttribute("address", "서울특별시 강남구 강남대로 14길1");
